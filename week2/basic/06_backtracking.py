...
def combinations(n, k): #wrapper
    ...
    def backtrack(start, current_combination):
        ...
        ## TODO: 백트랙킹 3단계 구현
        ## 1. 선택(Choose) current_combination.append(i)
        ## 2. 탐색(Explore) backtrack(i+1, current_combination)
        ## 3. 취소(Unchoose) current_combination.pop()
